...
AI Forge never invents features and never estimates counts. Every number and link it prints traces to a real pull request, Trac ticket or changeset. When you (or an agent) write the prose around it, keep it that way: each highlight should point at something the tool actually found.
